const CACHE_NAME = 'n3-jlpt-v12-fast-renshu-audit';
...
self.addEventListener('fetch', event => {
  ...
  const fresh = p.endsWith('/n3-jlpt-app/') || p.endsWith('/n3-jlpt-app/index.html') || p.endsWith('/n3-jlpt-app/fast-renshu.html') || p.endsWith('/n3-jlpt-app/fast-renshu-safe.html') || p.endsWith('/n3-jlpt-app/sw.js');
  if (fresh) {
